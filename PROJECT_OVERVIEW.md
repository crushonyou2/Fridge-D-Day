...
> **현재 공개 상태: v1.0.2 Released (원스토어, 2026-08-12) / QA hardening active — 공개 배포 이력 2건**
...
## 🚀 역사적 확장 아이디어 (제품 기능 로드맵으로는 비활성)

아래 항목은 초기 구상 기록이며 현재 제품 기능 로드맵이 아니다. 마지막 공개 스토어 배포는 v1.0.2(원스토어, 2026-08-12)다. 2026-09-09부터는 새 기능 확장이 아니라 QA hardening을 재개해 bundled OCR 가용성 검증, 누락 형식 실사진 coverage 보완, 이후 별도 UI/UX 리디자인과 최종 재출시를 진행한다. 가족 공유·IoT·레시피 추천 같은 아래 기능 아이디어는 이번 완성 범위에 포함하지 않는다.
...
**문서 작성일**: 2025년 1월 (최종 갱신 2026-09-09)
**프로젝트 버전**: 1.0.2
**버전 코드**: 4
**Target SDK**: 36
**프로젝트 상태**: v1.0.2 Released (원스토어, 2026-08-12) / QA hardening active / 공개 배포 이력 2건
